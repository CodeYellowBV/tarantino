/*
 * browser.js: Browser specific functionality for tarantino.
 *
...
function dlocHashEmpty() {
  // Non-IE browsers return '' when the address bar shows '#'; Tarantino's logic
...
export function Router(routes) {
  ...
  // `Object.assign` is relatively new. Is there another easy way without introducing an extra dependency?
  Object.assign(this, BaseRouter.prototype);
